...
public static class ServiceCollectionExtensions
{
    ...
    (
        ...
        Action<ManagedSignalROptions> configurer
    )
    {
        // Configure the framework options 
        ManagedSignalROptions frameworkOptions = new ManagedSignalROptions(services);
        ...
        ManagedSignalROptions.Instance = frameworkOptions;

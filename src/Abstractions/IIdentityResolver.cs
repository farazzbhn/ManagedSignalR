...
/// The id can be later passed to <see cref="ManagedHubHelper{T}.TryPush"/> to send fan-out messages to the user's active connections.
/// </summary>
public interface IIdentityResolver
{
    ...
    /// The id can be later passed to <see cref="ManagedHubHelper{T}.TryPush"/> to send fan-out messages to user's active connections.
    /// </summary>
    /// <remarks>
